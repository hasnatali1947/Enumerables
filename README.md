...
**[Enumerables]** is based on Ruby Language code to learn the usage of using modules and classes.
...
`
git clone https://github.com/zunairkhan811/Enumerables.git
`
...
Clone this [repository](https://github.com/zunairkhan811/Enumerables.git) to your desired folder.
...
- Clone this [repository](https://github.com/zunairkhan811/Enumerables.git) in your local machine with correct branch.
...
Feel free to check the [https://github.com/zunairkhan811/Enumerables/issues]
...
- **[What is Morse Code Project?]**
  ...
  - [In this project, we see how enumerables are used and the use of method and class 
  has been used]
